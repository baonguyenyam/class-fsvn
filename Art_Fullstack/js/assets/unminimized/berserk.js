...
(function ($) {
  ...
  $(function () {
    ...
    // If this is not HTML then run behaviors
    if (typeof(brs_l10n) !== 'undefined') {
  ...
  // Smooth scroll
  Berserk.behaviors.smooth_scroll_init = {
    attach: function (context, settings) {
      $("a:not(.nohash-animat)").on('click', function (event) {
        if (this.hash !== "" && this.hash !== "#top" && this.getAttribute("data-toggle") !== "collapse" && this.getAttribute("data-toggle") !== "tab" && !$(this).hasClass('fancybox') && !$(this).parent().parent().get(0).getAttribute("data-tabgroup")) {
